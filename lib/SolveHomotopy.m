...
while iter < maxiter
    ...
    %[num2str(iter), ' ', num2str(i_delta), ' ' , num2str(delta),' ', num2str(out_x)]
    ...
    %[Primal_constrk, delta*dk,  z_x, delta*del_x_vec,xk_1]
...
%['  ' 'delta1 ' num2str(delta1) ' delta2 ' num2str(delta2) ' delta3 ' num2str(delta3)]
% 
